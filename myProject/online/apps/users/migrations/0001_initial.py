    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default.png', upload_to='users/%Y/%m', verbose_name='用户头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=200, upload_to='banners/%Y/%m', verbose_name='轮播图')),
                ('banner_url', models.URLField(default='www.baidu.com', max_length=100, verbose_name='轮播图链接')),
